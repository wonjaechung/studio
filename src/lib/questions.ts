...
export const statsQuestions: Question[] = [
  ...
  },
  {
      ...
      questionText: "A least-squares model predicts that the more baggage items that are unloaded from a flight, the greater the time required to deliver the items to the baggage claim area.",
      answerOptions: [
